...
#define HEAD		"/std/armor/head"	// 护头
#define NECK		"/std/armor/neck"	// 护颈
#define CLOTH		"/std/armor/cloth"	// 衣服
#define ARMOR		"/std/armor/armor"	// 盔甲
#define SURCOAT		"/std/armor/surcoat"	// 外套
#define WAIST		"/std/armor/waist"	// 护腰
#define WRISTS		"/std/armor/wrists"	// 护腕
#define SHIELD		"/std/armor/shield"	// 盾
#define FINGER		"/std/armor/finger"	// 护指
#define HANDS		"/std/armor/hands"	// 护手
#define BOOTS		"/std/armor/boots"	// 鞋
