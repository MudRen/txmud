 ...
 */
static int min_age = 15;	// 15岁以前不能典当。
static int min_exp = 20000;	// exp < 20000 不能典当
static int min_value = 1000;	// 价值小于 10 两银子的物品当铺不收
...
int do_sellt(object ob,object me)
{
	...
	message_vision("$N把身上的"+ob->query("name")+"拿出卖了"+chinese_value(value)+"。\n",me);
