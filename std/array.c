...
private string mp,	// 阵法所属门派
	name,		// 阵法名称
	ski_name,	// 此阵法的 id
	su_msg,		// 成阵讯息
	skill_type;	// 阵法所用的武功

private int num,		// 阵法要求的人员数量
	master_level,		// 阵主阵法等级
	member_level,		// 成员阵法等级
...
nomask int query_effective_level()
{ return e_level; }
...
nomask void set_menpai(string arg)
{
	...
	if(stringp(arg) && (file_size("/daemon/skill/"+arg) == -2))
		mp = arg;
}
...
int query_master_skill_level()
{ return master_skill_level; }
...
int query_member_skill_level()
{ return member_skill_level; }
