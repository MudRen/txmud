...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","tilian");	// 房主的 ID。
	set("master_name","阿莲"); // 房主的中文名。
	set("exits",([
	"west" : __DIR__"tilian_home2",
	"east" : "/d/fengtian/guanlu4",
	]));
	...
	setup();
        create_door("east", "柳木门", "west", DOOR_CLOSED,LOCKED,__DIR__"tilian_key");

}

string query_save_file()
{
	return HOME_DIR+"fengtian/tilian_home_data";
}
