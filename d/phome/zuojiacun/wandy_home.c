...
LONG
	...
	set("master_id","wandy");	// 房主的 ID。
	set("master_name","狂龙"); // 房主的中文名。
	set("exits",([
	"south" : "/d/zuojiacun/jing",
	]));

	call_out("check_room",1);
	setup();
        create_door("south", "竹门", "north", DOOR_CLOSED,LOCKED,__DIR__"wandy_key");

}

string query_save_file()
{
	return HOME_DIR+"zuojiacun/wandy_home_data";
}
