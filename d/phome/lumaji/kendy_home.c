...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","kendy");	// 房主的 ID。
	set("master_name","冰缘"); // 房主的中文名。
	...
	setup();
        create_door("west", "木门", "east", DOOR_CLOSED,LOCKED,__DIR__"kendy_key");

}

string query_save_file()
{
	return HOME_DIR+"lumaji/kendy_home_data";
}
