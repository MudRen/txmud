...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","redtea");	// 房主的 ID。
	set("master_name","红茶"); // 房主的中文名。
	set("valid_startroom", 1);
	set("exits",([
	"west"  : "/d/datong/jinyangjie1",
	]));

	call_out("check_room",1);
	setup();
        create_door("west", "木门", "east", DOOR_CLOSED,LOCKED,__DIR__"redtea_key");

}

string query_save_file()
{
	return HOME_DIR+"datong/redtea_home_data";
}
