...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","fengjs");	// 房主的 ID。
	set("master_name","风剑书"); // 房主的中文名。
	set("exits",([
	"west" : __DIR__"fengjs_home2",
	"east" : "/d/datong/jinyangjie6",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("east", "红漆大门", "west", DOOR_CLOSED,LOCKED,__DIR__"fengjs_key");
}

string query_save_file()
{
	return HOME_DIR+"datong/fengjs_home_data";
}
