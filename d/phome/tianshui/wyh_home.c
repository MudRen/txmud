...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","wyh");	// 房主的 ID。
	set("master_name","弯湾鱼"); // 房主的中文名。
	set("exits",([
	"south" : __DIR__"wyh_home2",
	"north" : "/d/tianshui/xiaolu4",
	]));
	...
	setup();
        create_door("north", "柳木门", "south", DOOR_CLOSED,LOCKED,__DIR__"wyh_key");

}

string query_save_file()
{
	return HOME_DIR+"tianshui/wyh_home_data";
}
