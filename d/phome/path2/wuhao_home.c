...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","wuhao");	// 房主的 ID。
	set("master_name","逍遥子"); // 房主的中文名。
	...
	setup();
        create_door("south", "木门", "north", DOOR_CLOSED,LOCKED,__DIR__"wuhao_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/wuhao_home_data";
}
