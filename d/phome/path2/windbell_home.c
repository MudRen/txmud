...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","windbell");	// 房主的 ID。
	set("master_name","风铃"); // 房主的中文名。
	...
	setup();
        create_door("north", "木门", "south", DOOR_CLOSED,LOCKED,__DIR__"windbell_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/windbell_home_data";
}
