...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","yuppie");	// 房主的 ID。
	set("master_name","雅痞"); // 房主的中文名。
	...
	setup();
        create_door("east", "木门", "west", DOOR_CLOSED,LOCKED,__DIR__"yuppie_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/yuppie_home_data";
}
