...
LONG
	...
	set("master_id","seng");	// 房主的 ID。
	set("master_name","风烈火"); // 房主的中文名。
	set("exits",([
	"east" : "/d/path2/ch_k42",
	]));
	...
	setup();
        create_door("east", "竹门", "west", DOOR_CLOSED,LOCKED,__DIR__"seng_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/seng_home_data";
}
