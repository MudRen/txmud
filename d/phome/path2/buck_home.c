...
LONG
	...
	set("master_id","buck");	// 房主的 ID。
	set("master_name","小北"); // 房主的中文名。
	set("exits",([
	"east" : "/d/path2/da_hou4",
	]));

	call_out("check_room",1);
	setup();
        create_door("east", "竹门", "west", DOOR_CLOSED,LOCKED,__DIR__"buck_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/buck_home_data";
}
