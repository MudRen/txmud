...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","syncmaster");	// 房主的 ID。
	set("master_name","诗力佳"); // 房主的中文名。
	...
	setup();
        create_door("north", "木门", "south", DOOR_CLOSED,LOCKED,__DIR__"syncmaster_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/syncmaster_home_data";
}
