...
LONG
	...
	set("master_id","shady");	// 房主的 ID。
	set("master_name","小猪"); // 房主的中文名。
	set("exits",([
	"south" : "/d/path2/da_hou7",
	]));

	call_out("check_room",1);
	setup();
        create_door("south", "竹门", "north", DOOR_CLOSED,LOCKED,__DIR__"shady_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/shady_home_data";
}
