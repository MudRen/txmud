...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","michle");	// 房主的 ID。
	set("master_name","惊云"); // 房主的中文名。
	...
	setup();
        create_door("south", "木门", "north", DOOR_CLOSED,LOCKED,__DIR__"michle_key");

}

string query_save_file()
{
	return HOME_DIR+"path2/michle_home_data";
}
