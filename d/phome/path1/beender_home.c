...
LONG
	...
	set("master_id","beender");	// 房主的 ID。
	set("master_name","贝恩达"); // 房主的中文名。
	set("exits",([
	"east" : "/d/path1/cc_tch7",
	]));

	call_out("check_room",1);
	setup();
        create_door("east", "竹门", "west", DOOR_CLOSED,LOCKED,__DIR__"beender_key");

}

string query_save_file()
{
	return HOME_DIR+"path1/beender_home_data";
}
