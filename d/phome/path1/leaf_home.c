...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","leaf");	// 房主的 ID。
	set("master_name","了红"); // 房主的中文名。
	...
	setup();
        create_door("west", "木门", "east", DOOR_CLOSED,LOCKED,__DIR__"leaf_key");

}

string query_save_file()
{
	return HOME_DIR+"path1/leaf_home_data";
}
