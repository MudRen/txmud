...
LONG
	...
	set("master_id","yezi");	// 房主的 ID。
	set("master_name","业"); // 房主的中文名。
	set("exits",([
	"south" : "/d/path1/tch_ft7",
	]));

	call_out("check_room",1);
	setup();
        create_door("south", "竹门", "north", DOOR_CLOSED,LOCKED,__DIR__"yezi_key");

}

string query_save_file()
{
	return HOME_DIR+"path1/yezi_home_data";
}
