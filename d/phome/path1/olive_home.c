...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","olive");	// 房主的 ID。
	set("master_name","原振侠"); // 房主的中文名。
	set("valid_startroom", 1);
	set("exits",([
	"east"  : "/d/path1/cc_tch1",
	]));

	call_out("check_room",1);
	setup();
        create_door("east", "木门", "west", DOOR_CLOSED,LOCKED,__DIR__"olive_key");

}

string query_save_file()
{
	return HOME_DIR+"path1/olive_home_data";
}
