...
LONG
	...
	set("master_id","seve");	// 房主的 ID。
	set("master_name","思卫"); // 房主的中文名。
	set("exits",([
	"south" : "/d/path1/tch_ft17",
	]));

	call_out("check_room",1);
	setup();
        create_door("south", "竹门", "north", DOOR_CLOSED,LOCKED,__DIR__"seve_key");

}

string query_save_file()
{
	return HOME_DIR+"path1/seve_home_data";
}
