...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","aba");	// 房主的 ID。
	set("master_name","流"); // 房主的中文名。
	set("exits",([
	"north" : __DIR__"aba_home2",
	"south" : "/d/hangzhou/pathy2",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("south", "红漆大门", "north", DOOR_CLOSED,LOCKED,__DIR__"aba_key");
}

string query_save_file()
{
	return HOME_DIR+"hangzhou/aba_home_data";
}
