...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","tome");	// 房主的 ID。
	set("master_name","陈枫"); // 房主的中文名。
	set("exits",([
	"north" : __DIR__"tome_home2",
	"south" : "/d/hangzhou/changanw4",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("south", "红漆大门", "north", DOOR_CLOSED,LOCKED,__DIR__"tome_key");
}

string query_save_file()
{
	return HOME_DIR+"hangzhou/tome_home_data";
}
