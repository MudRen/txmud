...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","toto");	// 房主的 ID。
	set("master_name","乱"); // 房主的中文名。
	set("exits",([
	"east" : __DIR__"toto_home2",
	"west" : "/d/changan/chengxf3",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("west", "红漆大门", "east", DOOR_CLOSED,LOCKED,__DIR__"toto_key");
}

string query_save_file()
{
	return HOME_DIR+"changan/toto_home_data";
}
