...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","konami");	// 房主的 ID。
	set("master_name","修道狼"); // 房主的中文名。
	set("exits",([
	"south" : __DIR__"konami_home2",
	"north" : "/d/changan/wroad8",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("north", "红漆大门", "south", DOOR_CLOSED,LOCKED,__DIR__"konami_key");
}

string query_save_file()
{
	return HOME_DIR+"changan/konami_home_data";
}
