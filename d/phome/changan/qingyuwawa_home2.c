...
// 等级 4，宅院,共三间，这是这是第二间-正房.

#define HOME_DIR	"/d/phome/"
#define CAN_SAVE_OBJECT	11	// 此房屋可以保存的物品数量。
#define MAX_FUR		3
...
LONG
	...
	set("exits",([
	"north" : __DIR__"qingyuwawa_home",
	"up"   : __DIR__"qingyuwawa_home3",
	]));
...
{
	return HOME_DIR+"changan/qingyuwawa_home_data2";
}
