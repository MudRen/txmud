...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","king");	// 房主的 ID。
	set("master_name","天涯"); // 房主的中文名。
	set("exits",([
	"west" : __DIR__"king_home2",
	"east" : "/d/changan/nroad8",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("east", "红漆大门", "west", DOOR_CLOSED,LOCKED,__DIR__"king_key");
}

string query_save_file()
{
	return HOME_DIR+"changan/king_home_data";
}
