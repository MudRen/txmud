...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","zolozolo");	// 房主的 ID。
	set("master_name","不怕输"); // 房主的中文名。
	set("exits",([
	"east" : __DIR__"zolozolo_home2",
	"west" : "/d/changan/eroad8",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("west", "红漆大门", "east", DOOR_CLOSED,LOCKED,__DIR__"zolozolo_key");
}

string query_save_file()
{
	return HOME_DIR+"changan/zolozolo_home_data";
}
