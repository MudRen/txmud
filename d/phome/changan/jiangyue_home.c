...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","jiangyue");	// 房主的 ID。
	set("master_name","恶神"); // 房主的中文名。
	set("exits",([
	"west" : __DIR__"jiangyue_home2",
	"east" : "/d/changan/wroad6",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("east", "红漆大门", "west", DOOR_CLOSED,LOCKED,__DIR__"jiangyue_key");
}

string query_save_file()
{
	return HOME_DIR+"changan/jiangyue_home_data";
}
