...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","think");	// 房主的 ID。
	set("master_name","思想"); // 房主的中文名。
	set("exits",([
	"south" : __DIR__"think_home2",
	"north" : "/d/kaifeng/kai96",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("north", "红漆大门", "south", DOOR_CLOSED,LOCKED,__DIR__"think_key");
}

string query_save_file()
{
	return HOME_DIR+"kaifeng/think_home_data";
}
