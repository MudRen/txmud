...
LONG
	...
	set(SAFE_ENV,1);
	set("master_id","fatcatd");	// 房主的 ID。
	set("master_name","若风"); // 房主的中文名。
	set("exits",([
	"north" : __DIR__"fatcatd_home2",
	"south" : "/d/kaifeng/kai134",
	]));

	call_out("check_room",1);
	set("outdoors","playerhome");
	setup();
        create_door("south", "红漆大门", "north", DOOR_CLOSED,LOCKED,__DIR__"fatcatd_key");
}

string query_save_file()
{
	return HOME_DIR+"kaifeng/fatcatd_home_data";
}
