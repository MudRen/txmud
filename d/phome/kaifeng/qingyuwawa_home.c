...
LONG
	...
	set("exits",([
	"north" : __DIR__"qingyuwawa_home2",
	"south" : "/d/kaifeng/kai11",
	]));
	...
	setup();
        create_door("south", "柳木门", "north", DOOR_CLOSED,LOCKED,__DIR__"qingyuwawa_key");

}

string query_save_file()
{
	return HOME_DIR+"kaifeng/qingyuwawa_home_data";
}
