...
void greeting(object ob)
{
	...
	message_vision("\n$N朝$n盈盈一福：奴家来伺候您了。奴叫红秀(hong xiu)。\n",this_object(),ob);
	message_vision("爷愿不愿意去奴的「登仙阁」，让我好好伺候伺候爷？(accept hong xiu)\n",this_object());
}

int accept_object(object who,object ob)
{
	object obj;
	if(!who->query_temp("jiyuan/shangqian") || who->query_temp("jiyuan/shangqian") != "红秀") return 0;
...
int do_sleep(string arg)
{
	...
	int i;
	if(!me->query_temp("jiyuan/sleep") || me->query_temp("jiyuan/sleep") != "红秀")
		return 0;
