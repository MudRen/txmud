...
void create()
{
	...
	set("long",@LONG
马大善原来是京城一个恶少，结交江湖人物为害地方。后来得洪七公点化，\n
散尽家财入了丐帮。现任丐帮长安分舵的传功使，如果你是丐帮三袋弟子，\n
可以找他试试升四袋。
LONG );

	create_family("丐帮", 7, "五袋弟子");
...
//	}
	if( (ob->query_skill("begging",1) < 100)
		...
		{
		command("say 我先回去学好[乞讨]和[丐帮心法]，否则难有所成。\n");
		return;
	}
