...
int do_drink(string arg)
{
	...
	{ 	
		...
		{	
			this_player()->set("eff_gin", e_gin+heal);
		}	
	} 
	...
	if (gin < e_gin )
	{
        ...
        {
            this_player()->set("gin", e_gin);
        } else
        {   
            this_player()->set("gin", gin+recover);
        }   
	}
